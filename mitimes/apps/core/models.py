...
class Matter(models.Model):
    ...
    def get_for_user(user):
        """
        Returns matters for user.
        """
        return Matter.objects.filter(activity__profile__user=user)
...
class Activity(models.Model):
    ...
    is_on_current_timesheet = models.BooleanField(default=False,)
    ...
    def save(self, *args, **kwargs):
        ...
        """
        if self.timesheet:
            self.is_on_current_timesheet = False
        models.Model.save(self, *args, **kwargs)

    @staticmethod
    def get_active_for_user(user):
        """
        Returns all active activities in log for current profile.
        """
        return Activity.objects.filter(profile__user=user, is_active=True,
                                       is_on_current_timesheet=False)

    @staticmethod
    def get_on_current_timesheet_for_profile(profile):
        """
        Returns all activities on current timesheet,
        not posted for current profile.
        """
        return Activity.objects.filter(profile__user=profile, is_active=True,
...
class Timesheet(models.Model):
    ...
    @staticmethod
    def get_not_emailed_for_profile(profile):
        """
